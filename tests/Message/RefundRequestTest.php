...
class RefundRequestTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->request->setChargeReference('ch_12RgN9L7XhO9mI')
            ->setAmount('10.00')
    ...
    public function testSendSuccess()
    {
        ...
        $this->assertSame('ch_1EXTLmBuLa9YAcAA4NSYRcwz', $response->getData()['charge']);
    }
    ...
    public function testSendError()
    {
        ...
        $this->assertSame('charge_already_refunded', $response->getCode());
    }
}
