...
class CaptureRequestTest extends TestCase
{
    ...
    {
        $this->request = new CapturePaymentIntentRequest($this->getHttpClient(), $this->getHttpRequest());
        $this->request->setPaymentIntentReference('foo');
    }

    public function testEndpoint()
    {
        $this->assertSame('https://api.stripe.com/v1/payment_intents/foo/capture', $this->request->getEndpoint());
    }

    public function testCaptureAmount()
    {
